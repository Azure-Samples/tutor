...
Respect prior interactions when available: $previous_chat
""")


INTERVIEW_PROMPT = Template(
   """
...
**NEVER** give information that wasn't previously shared in the chat.
Replying with information that wasn't shared is considered cheating.
