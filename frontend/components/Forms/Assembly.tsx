...
import { FaBook, FaHashtag, FaUserFriends } from "react-icons/fa";
...
const AssemblyForm: React.FC<{
  ...
  return (
    ...
    >
      <label htmlFor="assembly-id" className="flex items-center gap-2 text-cyan-700 font-bold">
      ...
      />
      <label htmlFor="assembly-agents" className="flex items-center gap-2 text-green-700 font-bold">
      ...
      />
      <label htmlFor="assembly-topic" className="flex items-center gap-2 text-blue-700 font-bold">
        <FaBook /> Topic Name
      </label>
      <input
        id="assembly-topic"
