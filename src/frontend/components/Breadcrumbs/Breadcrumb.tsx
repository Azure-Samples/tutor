...
const Breadcrumb = ({ pageName, subtitle }: BreadcrumbProps) => {
  return (
    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between bg-gradient-to-r from-cyan-50 to-green-50 dark:from-blue-900 dark:to-green-900 rounded-xl p-4 shadow-md border border-cyan-100 dark:border-cyan-900 animate-fade-in">
      <div>
